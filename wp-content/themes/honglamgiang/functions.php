...
function theme_setup()
{
    ...
    add_image_size('partner-image', 9999, 34, true);
...
class main_menu extends Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if($depth == 0) {
            ...
            $class_names = $class_names ? ' class="dropdown-submenu ' . esc_attr( $class_names ) . '"' : '';
        }
        ...
        if($depth == 0) {
            ...
            $item_output .= '<a'. $attributes .' class="dropdown-item dropdown-toggle">';
...
class footer_menu extends Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $class_names = join( ' ', apply_filters( 'nav_menu_css_class', array_filter( $classes ), $item, $args, $depth ) );
        $class_names = $class_names ? ' class="mb-2"' : '';

        $output .= $indent . '<li' . $id . $class_names .'><i class="fas fa-angle-right mr-2 ml-1"></i>';
